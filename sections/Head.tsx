...
export default function HeadComponent({
  ...
  return (
    <Head>
      ...
      <meta property="business:contact_data:street_address" content="Praça do Derby, 149" />
      ...
      <meta property="business:contact_data:email" content="contact@labcodes.com.br" />
      <link
        rel="shortcut icon"
        href={faviconUrl}
        type="image/x-icon"
