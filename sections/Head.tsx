    ...
    <Head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: (`
                ...
                'https://pages.labcodes.com.br/proxy?url=https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','https://pages.labcodes.com.br/proxy?url=https://www.google-analytics.com/analytics.js','ga');
        ...
        <>
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              ...
              b.src = "https://pages.labcodes.com.br/proxy?url=https://snap.licdn.com/li.lms-analytics/insight.min.js";
          ...
          <noscript
            dangerouslySetInnerHTML={{
              ...
              <img
                ...
                style="display:none;"
                alt=""
                src='https://pages.labcodes.com.br/proxy?url=https://px.ads.linkedin.com/collect/?pid=${linkedinInsightTagKey}&fmt=gif'
              />
            `,
            }}
          >
      ...
      {leadfeederTrackerKey && (
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `
            (function () { window.ldfdr = window.ldfdr || {}; (function (d, s, ss, fs) { fs = d.getElementsByTagName(s)[0]; function ce(src) { var cs = d.createElement(s); cs.src = src; setTimeout(function () { fs.parentNode.insertBefore(cs, fs) }, 1); } ce(ss); })(document, 'script', 'https://pages.labcodes.com.br/proxy?url=https://sc.lfeeder.com/lftracker_v1_${leadfeederTrackerKey}.js'); })();
          `,
          }}
        >
        </script>
