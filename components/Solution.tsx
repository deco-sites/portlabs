...
export default function ({
  ...
  return (
    <section
      class={`solution-splendid-spoon box-border lg:h-[492px] lg:pb-24 bg-${backgroundColor}`}
    >
      <div class="solution-splendid-spoon__row pt-0">
        <div class="solution-splendid-spoon__image xl:max-w-[40%]">
          ...
          <Picture class="solution-splendid-spoon__first-img hidden 2lg:block mb-0 bg-none h-[900px]">
            ...
            />
            <img
              class="object-cover object-center-top h-[492px] w-full md:rounded-br-[160px]"
              loading="lazy"
              src={desktopImage}
            />
          </Picture>
